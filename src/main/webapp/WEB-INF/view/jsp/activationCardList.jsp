        ...
        <div class="d-flex flex-column mb-3">
            <div class="p-2">
                <div class="vstack gap-1 ">
                    ...
                    <div class="bg-light border">${principal.username} , select the card you want to unlock</div>
                </div>
            </div>
            <div class="p-1">
                <table class="table">
                    ...
                    <c:forEach items="${cards}" var="card">
                        <c:if test="${card.cardAccount.accountStatus.statusName == 'BLOCKED'&& card.cardAccount.accountStatusRequest.statusRequestName == 'FALSE'}">
                            <tr>
                                ...
                                <td><form action="<c:url value="/main/activationRequestSend"/>">
